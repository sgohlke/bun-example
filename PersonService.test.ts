...
test('All persons are returned', () => {
   ...
   expect(personList[0]).toEqual(new Person(1, 'Meier', 'Hans', 40));
   expect(personList[1]).toEqual(new Person(2, 'Mahler', 'Sandra', 32));
   expect(personList[2]).toEqual(new Person(3, 'Huber', 'Franz', 56));
});
